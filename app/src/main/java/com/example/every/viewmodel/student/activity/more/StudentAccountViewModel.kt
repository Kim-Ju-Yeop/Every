package com.example.every.viewmodel.student.activity.more
...
class StudentAccountViewModel : BaseViewModel(){
    ...
    fun getStudentInfo(studentName : TextView, studentEmail : TextView, studentPhone : TextView, studentSchool : TextView, studentBirth : TextView){
